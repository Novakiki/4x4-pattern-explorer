export default function PatternMatrix({ patterns, onPatternClick }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {patterns.map((pattern) => (
        <button
          ...
          className="group bg-white rounded-lg border-2 border-stone-200 p-6 hover:border-stone-400 hover:shadow-lg transition-all text-left"
        >
